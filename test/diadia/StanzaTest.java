...
class StanzaTest {
	...
	void testGetAttrezziNessunAttrezzo() {
		for (int i=0; i<NUMERO_MASSIMO_ATTREZZI; i++) {
			assertEquals(stanza1.getAttrezzi()[i],null);
		}
	}
	...
	void testHasAttrezzoNoAttrezzi() {
		assertEquals(stanza1.hasAttrezzo("padella"),false);
	}
	...
	void testHasAttrezzoSi() {
		stanza1.addAttrezzo(computer);
		assertEquals(stanza1.hasAttrezzo("computer"),true);
	}
	
	@Test 
	void testGetAttrezzoNull() {
		assertEquals(stanza1.getAttrezzo("computer"),null);
	}
	...
	void testRemoveAttrezzoNonCeLHa() {
		assertEquals(stanza1.removeAttrezzo(computer),false); 
	}
	
	@Test
	void testRemoveAttrezzoCeLHa() {
		stanza1.addAttrezzo(computer);
		assertEquals(stanza1.removeAttrezzo(computer),true); 
		assertEquals(stanza1.hasAttrezzo("computer"),false); 
	}
